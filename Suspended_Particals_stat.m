...
if nx==1
plot([zMin,zMax],[yMin yMax],'Color',"non")
...
%             Loc{I,J,K}=[x1,x2,y1,y2,z1,z2]
            plot(Loc{I,J,K}(5),Loc{I,J,K}(3))
            text(Loc{I,J,K}(5)+dz/2,Loc{I,J,K}(3)+dy/2, num2str(nP(I,J,K)/nPartTotal*100,'%3.1f\\%%'),...
    'Color','k','FontSize',fontSize,'Interpreter','Latex','BackgroundColor','none');
...
plot([zMin,zMax],[xMin xMax],'Color',"non")
...
%             Loc{I,J,K}=[x1,x2,y1,y2,z1,z2]
            plot(Loc{I,J,K}(5),Loc{I,J,K}(3))
            text(Loc{I,J,K}(5)+dz/2,Loc{I,J,K}(1)+dx/2, num2str(nP(I,J,K)/nPartTotal*100,'%3.1f\\%%'),...
    'Color','k','FontSize',fontSize,'Interpreter','Latex','BackgroundColor','none');
